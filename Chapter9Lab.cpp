...
int main() 
{
    ...
    // Call structural processing functions
    ...
    outFile << endl;
    outFile << "Highest Test Score: " << highestScore << endl << endl;
    ...
    cout << "Report successfully generated in '" << outFileName << "'" << endl;
    
    return 0;
}

// Implementation of readStudentsData
void readStudentsData(ifstream& inFile, studentType roster[], int size)
{
...
// Implementation of assignGrades
void assignGrades(studentType roster[], int size)
{
    for (int i = 0; i < size; i++)
    {
...
// Implementation of findHighestScore
int findHighestScore(const studentType roster[], int size)
{
...
// Implementation of printHighestScorers
void printHighestScorers(ostream& out, const studentType roster[], int size, int highestScore)
{
    for (int i = 0; i < size; i++)
    {
...
// Implementation of printGradeReport
void printGradeReport(ostream& out, const studentType roster[], int size)
{
    out << "---------------------------------------------" << endl;
    out << "            ANNUAL CLASS GRADE REPORT" << endl;
    out << "---------------------------------------------" << endl;
    out << left << setw(27) << "Student Name" << setw(12) << "Test Score" << "Grade" << endl;
    out << "---------------------------------------------" << endl;
    
    for (int i = 0; i < size; i++)
    {
        string fullName = roster[i].studentLName + ", " + roster[i].studentFName;
        out << left << setw(27) << fullName 
